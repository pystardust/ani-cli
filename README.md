...
**For Debian/Ubuntu-based distributions, you can use the automated dependency installation script:**

```sh
curl -sL https://raw.githubusercontent.com/pystardust/ani-cli/master/install-scripts/install-dependencies.sh | bash
```

Then install ani-cli:
