...
pkg install ani-cli
```
Make sure to add the referrer in mpv by opening mpv [(playstore version)](https://play.google.com/store/apps/details?id=is.xyz.mpv&hl=en_US), going into Settings -> Advanced -> Edit mpv.conf and adding:
