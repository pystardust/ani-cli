...
* [sho](https://github.com/scapy47/Sho): Cross Platform, Blazingly Fast TUI Anime Browser with Zero Dependency other then libc (and curl maybe) inspired by ani-cli (rust)
