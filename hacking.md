# Hacking ani-cli
Ani-cli is set up to scrape one platform - currently animekai. Supporting multiple sources at a time would require more changes than we (the maintainers) find worth doing, for this reason any feature request asking for a new site is rejected.
